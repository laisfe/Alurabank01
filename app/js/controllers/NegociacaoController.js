        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    const negociacao = new Negociacao_1.Negocioacao(new Date(this._inputData.val().replace(/-/g, ',')), parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val()));
